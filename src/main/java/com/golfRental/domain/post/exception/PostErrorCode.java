...
public enum PostErrorCode implements ErrorCode {
    ...
    // deleteFavorites
    POST_NOT_FAVORITES(HttpStatus.BAD_REQUEST, "해당 게시물의 즐겨찾기가 되어있지 않습니다."),
    ...
    // deleteImages
    POST_IMAGE_NEED(HttpStatus.BAD_REQUEST, "게시물에 하나 이상의 이미지 있어야 합니다.");
