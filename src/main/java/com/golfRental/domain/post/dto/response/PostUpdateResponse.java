...
public record PostUpdateResponse(
    ...
    public static PostUpdateResponse from(Post post, boolean postFavorites, List<PostImageResponse> imagesResponse) {
        return new PostUpdateResponse(
                ...
                post.getCategory().getId(), post.getCategory().getName(), postFavorites, imagesResponse
        );
    }
}
